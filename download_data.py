...
try:
    # 2846 HK is an ETF that tracks CSI, this is only used to get a list of constituent stocks in the CSI 300 Index to define the universe of stocks to study.
